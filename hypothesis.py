...
# ──────────────────────────────────────────────────────────────────────────────
PRESENTATION_EVAL_PROMPT = """You are a drug discovery expert. Evaluate the evidence for {gene} in {disease}.

Evidence:
{context}

Output ONLY this JSON (no markdown, no extra text). Use actual data from the evidence:

{{
  "genetic_association":    {{"rating": "✅ Strong / 🟡 Moderate / 🔴 Weak / ⬜ No data", "finding": "specific finding in ≤20 words"}},
  "functional_association": {{"rating": "...", "finding": "..."}},
  "clinical_relevance":     {{"rating": "...", "finding": "..."}},
  "network_context":        {{"rating": "...", "finding": "..."}},
  "target_validity_overall":{{"rating": "...", "finding": "..."}},
  "repositioning_potential":{{"rating": "...", "finding": "..."}},
  "safety_risk":            {{"rating": "...", "finding": "..."}},
  "modality_fit":           {{"rating": "...", "finding": "..."}},
  "overall_confidence":     {{"rating": "...", "finding": "one sentence hypothesis summary"}}
}}
"""

PRESENTATION_EVAL_PROMPT_JA = """あなたは創薬の専門家です。以下のエビデンスに基づき、{gene}の{disease}に対するエビデンス評価を行ってください。
...
{{
  "genetic_association":    {{"rating": "✅ 強い / 🟡 中程度 / 🔴 弱い / ⬜ データなし", "finding": "具体的な知見を30字以内で"}},
  "functional_association": {{"rating": "...", "finding": "..."}},
  "clinical_relevance":     {{"rating": "...", "finding": "..."}},
  "network_context":        {{"rating": "...", "finding": "..."}},
  "target_validity_overall":{{"rating": "...", "finding": "..."}},
  ...
  "safety_risk":            {{"rating": "...", "finding": "..."}},
  "modality_fit":           {{"rating": "...", "finding": "..."}},
  "overall_confidence":     {{"rating": "...", "finding": "仮説の一文要約"}}
}}
"""
